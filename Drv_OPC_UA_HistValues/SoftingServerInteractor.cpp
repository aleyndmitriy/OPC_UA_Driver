...
DrvOPCUAHistValues::Record mapRecordFromDataValue(const SoftingOPCToolbox5::DataValue& dataValue)
{
	...
	serverDataTime.wYear = dataValue.getServerTimestamp()->year();
	serverDataTime.wMonth = dataValue.getServerTimestamp()->month();
	serverDataTime.wDay = dataValue.getServerTimestamp()->day();
	serverDataTime.wHour = dataValue.getServerTimestamp()->hour();
	serverDataTime.wMinute = dataValue.getServerTimestamp()->minute();
	serverDataTime.wSecond = dataValue.getServerTimestamp()->second();
	serverDataTime.wMilliseconds = dataValue.getServerTimestamp()->milliSecond();

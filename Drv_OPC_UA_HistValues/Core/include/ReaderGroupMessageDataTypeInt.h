...
#ifndef _ReaderGroupMessageDataTypeInt_H_
#define _ReaderGroupMessageDataTypeInt_H_
...
{
	ReaderGroupMessageDataTypeInt() { }
	ReaderGroupMessageDataTypeInt(const ReaderGroupMessageDataTypeInt&) { }
	virtual ~ReaderGroupMessageDataTypeInt() { }

	virtual ReaderGroupMessageDataTypeInt *clone() const = 0;
	virtual EnumStatusCode set(const ReaderGroupMessageDataTypeInt &source) = 0;
	virtual int compare(const ReaderGroupMessageDataTypeInt *pTarget) const = 0;
...
#endif //_ReaderGroupMessageDataTypeInt_H_
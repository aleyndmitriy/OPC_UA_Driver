...
//lint -sem(ParsingResultStruct::init, initializer)
typedef struct TBCORE_IF ParsingResultStruct
{
	/*!
	...
	OTUInt32 dataStatusCodes_count;
	...
	* no diagnostic information was encountered in processing of the query request. */
	...
	OTUInt32 dataDiagnosticInfos_count;

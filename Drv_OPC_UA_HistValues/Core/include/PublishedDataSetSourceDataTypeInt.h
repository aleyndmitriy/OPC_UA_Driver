...
#ifndef _PublishedDataSetSourceDataTypeInt_H_
#define _PublishedDataSetSourceDataTypeInt_H_
...
{
	PublishedDataSetSourceDataTypeInt() { }
	PublishedDataSetSourceDataTypeInt(const PublishedDataSetSourceDataTypeInt&) { }
	virtual ~PublishedDataSetSourceDataTypeInt() { }

	virtual int compare(const PublishedDataSetSourceDataTypeInt *pTarget) const = 0;
	virtual EnumStatusCode set(const PublishedDataSetSourceDataTypeInt &source) = 0;
	virtual PublishedDataSetSourceDataTypeInt *clone() const = 0;
...
#endif //_PublishedDataSetSourceDataTypeInt_H_
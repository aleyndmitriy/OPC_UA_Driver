...
#ifndef _DataSetWriterMessageDataTypeInt_H_
#define _DataSetWriterMessageDataTypeInt_H_
...
{
	DataSetWriterMessageDataTypeInt() { }
	DataSetWriterMessageDataTypeInt(const DataSetWriterMessageDataTypeInt&) { }
	virtual ~DataSetWriterMessageDataTypeInt() { }

	virtual DataSetWriterMessageDataTypeInt *clone() const = 0;

	virtual int compare(const DataSetWriterMessageDataTypeInt *pTarget) const = 0;
	virtual EnumStatusCode set(const DataSetWriterMessageDataTypeInt &source) = 0;
...
#endif //_DataSetWriterMessageDataTypeInt_H_
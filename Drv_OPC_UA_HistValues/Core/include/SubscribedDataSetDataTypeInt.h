...
#ifndef _SubscribedDataSetDataTypeInt_H_
#define _SubscribedDataSetDataTypeInt_H_
...
{
	SubscribedDataSetDataTypeInt() { }
	SubscribedDataSetDataTypeInt(const SubscribedDataSetDataTypeInt&) { }
	virtual ~SubscribedDataSetDataTypeInt() { }

	virtual SubscribedDataSetDataTypeInt *clone() const  = 0;
	virtual EnumStatusCode set(const SubscribedDataSetDataTypeInt &source) = 0;
	virtual int compare(const SubscribedDataSetDataTypeInt *pTarget) const = 0;
...
#endif //_SubscribedDataSetDataTypeInt_H_
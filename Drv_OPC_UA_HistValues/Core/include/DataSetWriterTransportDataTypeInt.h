...
#ifndef _DataSetWriterTransportDataTypeInt_H_
#define _DataSetWriterTransportDataTypeInt_H_
...
{
	DataSetWriterTransportDataTypeInt() { }
	DataSetWriterTransportDataTypeInt(const DataSetWriterTransportDataTypeInt&) { }
	virtual ~DataSetWriterTransportDataTypeInt() { }

	virtual EnumStatusCode set(const DataSetWriterTransportDataTypeInt &source) = 0;
	virtual DataSetWriterTransportDataTypeInt *clone() const = 0;

	virtual int compare(const DataSetWriterTransportDataTypeInt *pTarget) const = 0;
...
#endif //_DataSetWriterTransportDataTypeInt_H_
...
#ifndef _WriterGroupTransportDataTypeInt_H_
#define _WriterGroupTransportDataTypeInt_H_
...
{
	WriterGroupTransportDataTypeInt() { }
	WriterGroupTransportDataTypeInt(const WriterGroupTransportDataTypeInt&) { }
	virtual ~WriterGroupTransportDataTypeInt() { }


	virtual int compare(const WriterGroupTransportDataTypeInt *pTarget) const = 0;
	virtual EnumStatusCode set(const WriterGroupTransportDataTypeInt &source) = 0;
	virtual WriterGroupTransportDataTypeInt *clone() const = 0;
...
#endif //_WriterGroupTransportDataTypeInt_H_
...
#ifndef _WriterGroupMessageDataTypeInt_H_
#define _WriterGroupMessageDataTypeInt_H_
...
{
	WriterGroupMessageDataTypeInt() { }
	WriterGroupMessageDataTypeInt(const WriterGroupMessageDataTypeInt&) { }
	virtual ~WriterGroupMessageDataTypeInt() { }

	virtual WriterGroupMessageDataTypeInt *clone() const = 0;
	virtual EnumStatusCode set(const WriterGroupMessageDataTypeInt &source) = 0;
	virtual int compare(const WriterGroupMessageDataTypeInt *pTarget) const = 0;
...
#endif //_WriterGroupMessageDataTypeInt_H_
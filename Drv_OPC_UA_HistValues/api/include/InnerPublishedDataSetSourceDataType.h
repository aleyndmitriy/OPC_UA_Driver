...
#ifndef INNERPUBLISHEDDATASETSOURCEDATATYPE_H
#define INNERPUBLISHEDDATASETSOURCEDATATYPE_H
...
namespace SoftingOPCToolbox5
{
	...
	class TBC_EXPORT InnerPublishedDataSetSourceDataType
		: public IPublishedDataSetSourceDataType
	{
	public:
		/*! Destructor */
		virtual ~InnerPublishedDataSetSourceDataType();

		/*! Returns the concrete data type of an instance of this abstract class. */
		virtual EnumDataTypeId getDataType() const;

		/*! For internal use only */
		void initInner(PublishedDataSetSourceDataTypeStruct* pHandle);
	...
	private:
		...
		PublishedDataSetSourceDataTypeStruct* m_pContent;
	};
} // end namespace
